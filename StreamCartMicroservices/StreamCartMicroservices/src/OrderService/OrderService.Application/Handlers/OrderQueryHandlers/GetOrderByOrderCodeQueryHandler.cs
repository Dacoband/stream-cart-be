...
{
    public class GetOrderByOrderCodeQueryHandler : IRequestHandler<GetOrderByOrderCodeQuery, OrderDto>
    {
        private readonly IOrderRepository _orderRepository;
        private readonly IProductServiceClient _productServiceClient;
        private readonly ILogger<GetOrderByOrderCodeQueryHandler> _logger;

        public GetOrderByOrderCodeQueryHandler(
            IOrderRepository orderRepository,
            IProductServiceClient productServiceClient,
            ILogger<GetOrderByOrderCodeQueryHandler> logger)
        {
        ...
        public async Task<OrderDto> Handle(GetOrderByOrderCodeQuery request, CancellationToken cancellationToken)
        {
            try
            {
