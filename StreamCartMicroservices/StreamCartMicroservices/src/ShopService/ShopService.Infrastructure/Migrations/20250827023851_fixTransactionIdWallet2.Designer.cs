...
namespace ShopService.Infrastructure.Migrations
{
    ...
    [Migration("20250827023851_fixTransactionIdWallet2")]
    partial class fixTransactionIdWallet2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopService.Domain.Entities.ShopDashboard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("OrderInLivestream")
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("RefundOrderCount")
                        .HasColumnType("integer")
                        .HasColumnName("refund_order_count");

                    b.Property<int>("RepeatCustomerCount")
                        .HasColumnType("integer")
                    ...
                    b.Property<List<TopProductInfo>>("TopAIRecommendedProducts")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("top_ai_recommended_products");

                    b.Property<List<TopProductInfo>>("TopOrderProducts")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("top_order_products");

                    b.Property<int>("TotalLivestream")
                        .HasColumnType("integer")
                        .HasColumnName("total_livestream");

                    b.Property<decimal>("TotalLivestreamDuration")
                        .HasColumnType("decimal(10,2)")
                        .HasColumnName("total_livestream_duration");

                    b.Property<int>("TotalLivestreamViewers")
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("ShopId", "FromTime", "ToTime", "PeriodType")
                        .HasDatabaseName("ix_shop_dashboards_period_lookup");

                    b.ToTable("shop_dashboards", (string)null);
                });
