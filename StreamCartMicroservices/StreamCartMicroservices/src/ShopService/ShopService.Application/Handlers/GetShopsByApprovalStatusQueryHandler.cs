...
{
    public class GetShopsByApprovalStatusQueryHandler : IRequestHandler<GetShopsByApprovalStatusQuery, IEnumerable<ShopDto>>
    {
        private readonly IShopRepository _shopRepository;

        public GetShopsByApprovalStatusQueryHandler(IShopRepository shopRepository)
        {
            _shopRepository = shopRepository;
        }

        public async Task<IEnumerable<ShopDto>> Handle(GetShopsByApprovalStatusQuery request, CancellationToken cancellationToken)
        {
            var shops = await _shopRepository.GetByApprovalStatusAsync(request.Status);
