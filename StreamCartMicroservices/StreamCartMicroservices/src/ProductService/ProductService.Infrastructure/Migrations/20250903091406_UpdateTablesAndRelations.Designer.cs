...
namespace ProductService.Infrastructure.Migrations
{
    ...
    [Migration("20250903091406_UpdateTablesAndRelations")]
    partial class UpdateTablesAndRelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProductService.Domain.Entities.FlashSale", b =>
                {
                    ...
                    b.HasIndex("Slot", "StartTime", "EndTime")
                        .HasDatabaseName("IX_FlashSales_Slot_StartTime_EndTime");

                    b.HasIndex("ProductId", "VariantId", "StartTime", "EndTime")
                        .HasDatabaseName("IX_FlashSales_Product_Variant_Time");

                    b.ToTable("Flash-Sales", null, t =>
                        {
                            t.HasCheckConstraint("CK_FlashSales_Slot", "\"Slot\" >= 1 AND \"Slot\" <= 8");
                        });
                });
