...
{
    public class UnassignAddressFromShopCommandHandler : IRequestHandler<UnassignAddressFromShopCommand, AddressDto>
    {
        private readonly IAddressRepository _addressRepository;

        public UnassignAddressFromShopCommandHandler(IAddressRepository addressRepository)
        {
            _addressRepository = addressRepository ?? throw new ArgumentNullException(nameof(addressRepository));
        }

        public async Task<AddressDto> Handle(UnassignAddressFromShopCommand request, CancellationToken cancellationToken)
        {
